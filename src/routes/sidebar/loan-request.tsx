    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="flex justify-evenly mt-6 gap-10 ">
        <div className="flex flex-col mt-8 items-center justify-normal">
          ...
          <Separator orientation="vertical" className="border border-gray h-full dashed-separator"/>
          <div className="flex flex-col mt-8 items-center justify-center h-full">
              <section className="w-full flex flex-col text-center items-center gap-12">
                  <div className="space-y-4"><h2 className="font-black text-3xl">Total Ammount Borrowed</h2>
                      <h3 className="text-[#54D4A0] text-2xl font-semibold">₦60,000.00</h3>
                  </div>
                  <div className="space-y-4"><h2 className="font-black text-3xl">Total Ammount To Be Paid</h2>
                      <h3 className="text-[#54D4A0] text-2xl font-semibold">₦60,000.00</h3>
                  </div>
                  <div className="w-full space-y-6">
                      <h2 className="font-black text-3xl">Due Date</h2>
                      <DatePicker className="w-full rounded border border-bordered"/>
                      <Button className="w-full border border-[#54D4A0] rounded">Request Loan</Button>
                  </div>
              </section>
